...
{"fields":{"cpus_on_node":36,"hostname":"gr0288","job_id":"17158464","message":"running","mpi_rank":0,"ntasks":8,"source":"daap_log","task_pid":5898},"name":"daap_heartbeat","tags":{"host":"gr0288.localdomain","jobinfo":"jobid=17158464 partition=debug name=sh user=hng st=r time=10:15 nodes=2 nodelist(reason)=gr[0288-0289]"},"timestamp":1602108543}]')
    end
